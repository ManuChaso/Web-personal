...
function Privacy() {
    return(
    	<div className="privacy">
	        ...
	        <p>&nbsp;</p>
	        <p>
	        	El presente Política de Privacidad establece los términos en que ManuChaso usa y protege
	        ...
	        <p>
	        	ManuChaso está altamente comprometido para cumplir con el compromiso de mantener su información
	        ...
	        <p>
	        	ManuChaso Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en
	        	cualquier momento.</p><p>Esta politica de privacidad se han generado en
